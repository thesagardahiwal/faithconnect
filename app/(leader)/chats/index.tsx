...
export default function ChatsList() {
  ...
  // Handle profile not loaded or loading state
  if (!profile || !profile.$id) {
    // You can render a skeleton or a loading state as desired
    return (
      <Screen>
        <Header title="Chats" />
        <View className="flex-1 justify-center items-center">
          <EmptyState
            ...
            text="Please make sure you are signed in and have a valid profile."
            actionLabel="Go Home"
    ...
    <Screen>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          let partner;
          try {
            partner = getChatPartner(item, profile.$id);
          } catch {
            partner = { name: 'Unknown', photoUrl: null };
          }
          const avatarUrl = partner.photoUrl ? partner.photoUrl : null;
